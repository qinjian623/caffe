...
HeatmapDataLayer<Dtype>::HeatmapDataLayer(const LayerParameter& param)
  : BasePrefetchingDataLayer<Dtype>(param),
    reader_(param) {
    this->heatmap_width = param.heatmap_data_param().heatmap_width();
    this->heatmap_height = param.heatmap_data_param().heatmap_height();
}

template <typename Dtype>
HeatmapDataLayer<Dtype>::~HeatmapDataLayer() {
