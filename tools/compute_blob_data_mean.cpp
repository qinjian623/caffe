...
int main(int argc, char** argv) {
  ...
  int count = 0;
  // load first datum
  MultiDatum multi_datum;
  multi_datum.ParseFromString(cursor->value());
  Datum datum = multi_datum.data(0);
  ...
  std::cout <<"Mean file size:" << datum.channels() <<','<< datum.height() <<','<< datum.width() << std::endl;
